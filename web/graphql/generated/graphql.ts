...
export type GetNewsFeedUrlAndReferencesQuery = { __typename?: 'Query', newsFeedUrl: { __typename?: 'NewsFeedUrl', urlId: number, urlScore: number, numReferences: number, firstReferencedByUsername: string, createdAt: number, title: string, description: string, expandedUrlParsed: string, expandedUrlHost: string, previewImageThumbnailUrl?: string | null, previewImageUrl?: string | null, displayUrl: string }, newsFeedUrlReferences: Array<{ __typename?: 'NewsFeedUrlReference', tweetId: number, tweetText: string, tweetCreatedAtStr: string, authorUsername: string, retweetedByUsernames: Array<string> }> };

export type GetNewsFeedUrlsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetNewsFeedUrlsQuery = { __typename?: 'Query', newsFeedUrls: Array<{ __typename?: 'NewsFeedUrl', urlId: number, urlScore: number, numReferences: number, firstReferencedByUsername: string, createdAt: number, title: string, description: string, expandedUrlParsed: string, expandedUrlHost: string, previewImageThumbnailUrl?: string | null, previewImageUrl?: string | null, displayUrl: string }> };
