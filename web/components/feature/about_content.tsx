...
const features = [
    ...
    {
        name: 'Open source',
        description: 'The source code for Walet is hosted on GitHub and everyone is free to review, audit, and contribute to the Walet codebase.',
        icon: BeakerIcon,
    },
    // {
    //     name: 'Multiple DEXs',
            ...
            <div className="relative py-8 sm:py-12 lg:py-16">
                <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                    {/* <img
                        ...
                        alt="Walet logo"
                    /> */}
                    <h2 className="text-base font-semibold uppercase tracking-wider text-primary">Climate Action Collective</h2>
                    <p className="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        Get smart, take action.
                    </p>
                    <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                        Climate Action Collective is a global initiative to move leaders to act on climate. 
                    </p>
                    <div className="mt-12">
